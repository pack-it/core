...
./Configure -des \
    ...
    -Dprefix=$active_dir \
    -Dprivlib=$PACKIT_PACKAGE_VERSION/lib/perl5/ \
    -Dsitelib=$PACKIT_PREFIX_PATH/lib/perl5/site_perl/$PACKIT_PACKAGE_VERSION \
    -Dvendorlib=$PACKIT_PREFIX_PATH/lib/perl5/vendor_perl/$PACKIT_PACKAGE_VERSION \
